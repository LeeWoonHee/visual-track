...
const mutations = {
  ...
  UPDATE_STARRED_PAGE (state, payload) {
    ...
    // if val is true add it to starred else.scss remove
    if (payload.val) {
  ...
  UPDATE_WINDOW_HEIGHT (state, height) { state.windowHeight = height },
  UPDATE_WINDOW_SCROLL_Y (state, val) { state.scrollY = val },
  UPDATE_WINDOW_SCROLL_DIRECTION (state, val) { state.scrollDirection = val },
  // /////////////////////////////////////////////
  // User/Account
  // /////////////////////////////////////////////
